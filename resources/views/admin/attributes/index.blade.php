...
<div class="container-fluid py-4">
    ...
    <ul class="nav nav-tabs mb-4" id="attributeTabs" role="tablist" style="border-bottom:1px solid var(--mb-border);">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link text-white fw-bold" id="colors-tab" data-bs-toggle="tab" data-bs-target="#colors" type="button" role="tab">
                🎨 Colors &amp; Swatches ({{ $colors->count() }})
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link text-white fw-bold" id="threads-tab" data-bs-toggle="tab" data-bs-target="#threads" type="button" role="tab">
                📐 Thread Sizes ({{ $threadSizes->count() }})
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link text-white fw-bold" id="brands-tab" data-bs-toggle="tab" data-bs-target="#brands" type="button" role="tab">
                    ...
                    <table class="table table-dark align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <tr style="border-bottom:1px solid rgba(255,255,255,0.05);">
                                ...
                                <td class="fw-bold text-white">{{ $mat->name }}</td>
                    ...
                    <table class="table table-dark align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <tr style="border-bottom:1px solid rgba(255,255,255,0.05);">
                                ...
                                <td class="fw-bold text-white">{{ $color->name }}</td>
                ...
                <div class="table-responsive">
                    <table class="table table-dark align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <tr style="border-bottom:1px solid rgba(255,255,255,0.05);">
                                <td style="color:var(--mb-muted);">{{ $loop->iteration }}</td>
                                <td class="fw-bold text-white">{{ $ts->name }}</td>
                                <td>{{ $ts->sort_order }}</td>
                                <td>
        ...
        <div class="tab-pane fade" id="brands" role="tabpanel">
            <div class="dark-card p-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h3 class="h5 text-white mb-0">Store Brands</h3>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        <div class="p-3" style="background:var(--mb-surface);border-radius:8px;border:1px solid var(--mb-border);">
                            <div class="fw-bold text-white mb-1">{{ $brand->name }}</div>
            ...
            <form method="POST" action="{{ route('admin.attributes.store') }}">
                ...
                <div class="modal-body py-3">
                    <div class="mb-3">
                        ...
                        <select name="type" class="form-select bg-dark text-white border-secondary" required onchange="toggleColorInput(this.value, 'add')">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control bg-dark text-white border-secondary" placeholder="e.g. Titanium Gr5 or Red" required>
                    </div>
                    <div class="mb-3" id="add-color-val-group" style="display:none;">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <input type="text" name="value" id="add-color-value" class="form-control bg-dark text-white border-secondary" placeholder="#f5a623">
                        </div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label text-muted">Sort Order</label>
                        <input type="number" name="sort_order" class="form-control bg-dark text-white border-secondary" value="0">
                    </div>
                </div>
            ...
            <form method="POST" id="editAttributeForm" action="">
                ...
                <div class="modal-body py-3">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" id="edit-name" class="form-control bg-dark text-white border-secondary" required>
                    </div>
                    <div class="mb-3" id="edit-color-val-group">
                        <label class="form-label text-muted">Color Hex Code / CSS Value</label>
                        <input type="text" name="value" id="edit-value" class="form-control bg-dark text-white border-secondary" placeholder="#f5a623">
                    </div>
                    <div class="mb-3">
                        <label class="form-label text-muted">Sort Order</label>
                        <input type="number" name="sort_order" id="edit-sort" class="form-control bg-dark text-white border-secondary">
                    </div>
                    <div class="form-check">
                        <input type="checkbox" name="is_active" id="edit-active" value="1" class="form-check-input">
                        <label class="form-check-label text-white" for="edit-active">Active in shop filters</label>
                    </div>
                </div>
                <div class="modal-footer border-0 pt-0">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
