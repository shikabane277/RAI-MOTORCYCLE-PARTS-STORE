                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex gap-1">
                            <a href="{{ route('admin.orders.show', $order) }}" class="btn btn-dark-surface btn-sm"><i class="bi bi-eye"></i></a>
                            <a href="{{ route('admin.orders.packing-slip', $order) }}" class="btn btn-dark-surface btn-sm" target="_blank"><i class="bi bi-printer"></i></a>
                        </div>
                    </td>
                </tr>
                @empty
