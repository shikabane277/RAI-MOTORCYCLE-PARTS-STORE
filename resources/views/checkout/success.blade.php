        ...
        <div class="col-lg-7">
            ...
            <div class="dark-card p-4 mb-4">
                ...
                <div class="mt-3">
                    ...
                    @endif
                    <div class="d-flex justify-content-between py-1" style="font-size:.9rem;"><span style="color:var(--mb-muted);">Shipping</span><span>{{ $order->shipping_fee == 0 ? 'FREE' : '₱'.number_format($order->shipping_fee, 2) }}</span></div>
            ...
            <div class="dark-card p-4 mb-4" style="border-color:rgba(245,166,35,0.3);">
                <h2 style="font-family:'Rajdhani',sans-serif;font-size:1.1rem;color:var(--mb-gold);margin-bottom:1rem;">
                    <i class="bi bi-wallet2 me-2"></i>Payment Instructions
                </h2>
                ...
                <div class="d-flex align-items-center gap-2 mb-2">
                    ...
                    <strong style="color:var(--mb-green);font-size:1.1rem;">Paid via Google Pay</strong>
                </div>
                <p style="color:var(--mb-text);">Your payment of <strong>&#x20B1;{{ number_format($order->grand_total, 2) }}</strong> has been authorized &amp; confirmed via Google Pay.</p>
                <p style="color:var(--mb-muted);font-size:.85rem;margin:0;">Transaction ID: <span style="font-family:monospace;color:var(--mb-gold);">GP-{{ strtoupper(Str::random(12)) }}</span> &bull; Your order will be dispatched shortly.</p>
            ...
            <div class="d-flex gap-3 flex-wrap">
                ...
                <a href="{{ route('order.track') }}" class="btn btn-dark-surface"><i class="bi bi-geo-alt me-1"></i>Track Order</a>
            </div>
        </div>
    </div>
</div>
